            ...
            <div class="d-flex justify-content-center form-container">
                <form action="login.php" method="post">
                    <div class="input-group mt-5">
                        ...
                        <input type="text" placeholder= "Enter Username" name="unamephone" id="unamephone" class="form-control input-user" required>
                    </div>
...
if(isset($_POST['submit'])){
    ...
    $pass = $_POST['pass'];
    $get_user = "SELECT * FROM admin WHERE  pass='$pass' AND uname = '$unamephone'";
    ...
    if($count>0)
    {
     ...
     echo"<script>window.open('index.php','_self')</script>";
            ...
            echo"<script>alert('The username or Password  was invalid')</script>";
