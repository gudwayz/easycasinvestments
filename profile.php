          ...
          <div class="col-md-10 mt-2 mb-1">
             ...
             <div class="card mb-3" style="max-width: 80vw">
               <div class="row no-gutters">
                 <div class="col-md-4">
                   <img src="g3.jpg" class="card-img" alt="gid">
                </div>
                 <div class="col-md-8">
                 <div class="card-body">
                   <h3 class="card-title">Investors Details</h3>
                 </div>
               </div>
               </div>
            </div>
               ...
               <?php
                   if(isset($_SESSION['uname'])){
                       $uname = $_SESSION['uname'];
                        $select_user = "SELECT * FROM user WHERE uname ='$uname'";
                    ...
                    while($user_rows){
                        ...
                        $address = $user_rows['contact'];
                        $city = $user_rows['city'];
                        
                        
                        echo"
                        
                        <p class='card-text my-2 d-flex justify-content-around'><h5>Name: </h5><span>$fname</span>&nbsp;<span>$lname</span>
                        </p>
                        
                        <p class='card-text my-2 d-flex justify-content-around'><h5>Email: </h5><span>$email</span>
                        </p>
                        <p class='card-text my-2 d-flex justify-content-around'><h5>contact: </h5><span>$address</span>
                        </p>
